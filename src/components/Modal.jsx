export default function Modal({ onClose, title, description, oneOption, actionButton, closeButton }) {
    ...
    return (
        <dialog open className="sm:max-w-[400px] sm:h-fit m-0 z-10 flex flex-col gap-4 justify-center absolute sm:top-[50%] sm:left-[50%] sm:-translate-x-[50%] sm:-translate-y-[50%] p-8 sm:rounded-xl sm:shadow-xl xs:w-full xs:h-screen xs:rounded-none xs:bg-[#ffffffcf]">
